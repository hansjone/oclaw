...
### Image / video specialist lanes (removed)

- Former Chat UI **image** / **video** specialist early-exit lanes were removed from the product surface.
- Ops/generalist sessions still use **`query_image_attachment`** (OCR / vision tool) when needed.
