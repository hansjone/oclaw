...
def build_memory_context(
    *,
    ...
    return OclawMemoryContext(short_term=short_term, semantic_hits=semantic_hits)


def render_memory_context_block(ctx: OclawMemoryContext) -> str:
    if not ctx.enabled:
        return ""
    ...
    *,
    ...
    try:
        ...
        if bool(auto.get("enabled", False)):
            ...
            if hasattr(store, "oclaw_task_create"):
                store.oclaw_task_create(
