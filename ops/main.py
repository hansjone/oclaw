...
from oclaw.ops.memory import register_memory_parser
from oclaw.ops.providers.registry import build_channel_registry
from oclaw.ops.stack import register_stack_parser
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="python -m oclaw.ops", description="Unified operational CLI")
