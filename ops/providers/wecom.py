...
from oclaw.channels.wecom.longconn_runner import run_forever as run_wecom_longconn
...
class WecomProvider(ChannelProvider):
    ...
    def _cmd_status(self, _args: argparse.Namespace) -> int:
        from scripts.wecom_status import main as status_main
    ...
    def _cmd_smoke(self, args: argparse.Namespace) -> int:
        from scripts.wecom_smoke_test import main as smoke_main
    ...
    def _cmd_switch(self, args: argparse.Namespace) -> int:
        ...
        print("next=python -m oclaw.ops channel wecom start")
        return 0
