...
from oclaw.openclaw_runtime.memory_stage import after_turn_memory
from oclaw.openclaw_runtime.types import AttemptState, OpenClawMemoryContext, StandardMessage
...
def run_attempt(*, store: Any, data: AttemptRunnerInput) -> AttemptRunnerOutput:
    try:
        outcome = run_openclaw_direct_loop(
            store=store,
