        ...
        out.append(
            {
                ...
                "metadata_openclaw": dict(m.metadata_openclaw),
                "runtime": runtime,
...
def _resolve_registry_archive_url(url: str) -> str:
    ...
    try:
        from oclaw.tools.skills.clawhub_client import get_skill_detail
    ...
    *,
    ...
    try:
        req = urllib.request.Request(
            url,
            headers={
                "User-Agent": "OpenClaw-SkillInstaller/1.0 (+https://clawhub.ai)",
                "Accept": "*/*",
            },
        )
...
def create_skill_from_template(
    *,
    ...
    description: str,
    body_markdown: str = "",
    metadata_openclaw: dict[str, Any] | None = None,
    skills_root: str | Path | None = None,
    overwrite: bool = False,
) -> SkillInstallResult:
