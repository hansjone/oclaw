...
OPENCLAW_DIR = HOOKS_PY_DIR.parent
if str(OPENCLAW_DIR) not in sys.path:
    sys.path.insert(0, str(OPENCLAW_DIR))

from hooks.internal_hooks import create_hook_event, trigger_hook  # noqa: E402
from hooks.loader import load_internal_hooks  # noqa: E402


def main() -> int:
    repo_root = Path(__file__).resolve().parents[1]
    bundled = repo_root / "hooks" / "bundled"
