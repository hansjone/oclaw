...
from oclaw.tools.mcp.market import infer_install_template, search_mcp_market, trending_mcp_market


class McpMarketTests(unittest.TestCase):
    @patch("oclaw.tools.mcp.market.search_github_repos")
    @patch("oclaw.tools.mcp.market.search_npm_packages")
    @patch("oclaw.tools.mcp.market.search_pypi_packages")
    ...
    @patch("oclaw.tools.mcp.market.search_mcp_market")
