...
from oclaw.openclaw_runtime.skills import build_skill_manifest, discover_workspace_skill_manifests, load_skill_manifest
from oclaw.tools.base import ToolRegistry, ToolSpec


def test_load_skill_manifest_with_openclaw_metadata(tmp_path: Path) -> None:
...
metadata: {"openclaw":{"install":[{"id":"i1","kind":"node","package":"foo"}]}}
---
