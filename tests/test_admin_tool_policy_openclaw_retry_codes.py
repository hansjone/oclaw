...
class AdminToolPolicyOpenClawRetryCodesTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_tool_policy_get_and_save_openclaw_retry_codes(self) -> None:
        token = self._login()
        ...
        self.assertTrue(str(b1.get("openclaw_retryable_error_codes") or "").strip())
        self.assertFalse(bool(b1.get("openclaw_retry_codes_strict_mode")))
        ...
        payload = {
            ...
            "mcp_env_allowlist": "",
            "openclaw_retryable_error_codes": "provider_timeout, context_overflow",
            "openclaw_retry_codes_strict_mode": False,
        ...
        self.assertEqual(str(b2.get("openclaw_retryable_error_codes") or ""), "provider_timeout,context_overflow")
        self.assertFalse(bool(b2.get("openclaw_retry_codes_strict_mode")))
    ...
    def test_tool_policy_retry_codes_unknown_filtered(self) -> None:
        ...
        payload = {
            ...
            "mcp_filesystem_extra_roots": "",
            "mcp_env_allowlist": "",
            "openclaw_retryable_error_codes": "provider_timeout, typo_code_x, context_overflow",
            "openclaw_retry_codes_strict_mode": False,
            "wecom_longconn_workers": 2,
            "wecom_longconn_inbound_queue_maxsize": 200,
        }
        ...
        self.assertEqual(str(b.get("openclaw_retryable_error_codes") or ""), "provider_timeout,context_overflow")
    ...
    def test_tool_policy_retry_codes_unknown_rejected_in_strict_mode(self) -> None:
        ...
        payload = {
            ...
            "mcp_filesystem_extra_roots": "",
            "mcp_env_allowlist": "",
            "openclaw_retryable_error_codes": "provider_timeout, typo_code_x",
            "openclaw_retry_codes_strict_mode": True,
            "wecom_longconn_workers": 2,
            "wecom_longconn_inbound_queue_maxsize": 200,
        }
        r = self.client.post("/admin/api/tool-policy", json=payload, headers=headers)
